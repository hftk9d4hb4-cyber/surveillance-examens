...
export default async function AdminPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <main className="container">
      <div className="page-header"><div><h1>Administration</h1><p className="muted">Gestion des droits, de l'activation des comptes et traçabilité des opérations.</p></div><a className="button" href="/admin/imports">Imports</a></div>
